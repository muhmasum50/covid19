...
<form action="<?=site_url('datadiri/edit')?>" method="post" enctype="multipart/form-data">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Profil Data Diri</h3>
      <button type="sumbit" class="btn btn-success btn-sm pull-right"><i class="fa fa-paper-plane"></i> Simpan</button>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group <?= form_error('kodepos') ? 'has-error':null ?>">
                    ...
                    <input type="text" class="form-control" name="kodepos" value="<?= $row->kodepos ?>">
                    <?= form_error('kodepos')?>
                </div>
                <div class="form-group <?= form_error('alamatlengkap') ? 'has-error':null ?>">
                    <label>Jalan / Alamat Lengkap</label>
                    <textarea name="alamatlengkap" class="form-control" cols="30" rows="4"><?= $row->alamatlengkap ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="foto_ktpsim">
                </div>
                <div class="form-group">
                    <label>FOTO KK</label>
                    <input type="text" class="form-control" name="foto_kk">
                </div> -->
            </div>
        </div>
    </div>
